...
class Generator4Embeds:
    ...
    def __init__(self, num_inference_steps=1, device='cuda') -> None:
        ...
        pipe = DiffusionPipeline.from_pretrained("/root/autodl-tmp/EEG2Vision/SDXL",torch_dtype=torch.float16,variant="fp16")
        ...
        pipe.load_ip_adapter(
            "/root/autodl-tmp/EEG2Vision/IP-Adapter",
...
if __name__ == "__main__":
    ...
    image_encoder, _, feature_extractor = open_clip.create_model_and_transforms(
        'ViT-H-14',
        pretrained='/root/autodl-tmp/EEG2Vision/CLIP-ViT-H-14-laion2B-s32B-b79K',
        precision='fp16',
        device='cuda'
    )
